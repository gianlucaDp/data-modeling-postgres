...
(songplay_id int PRIMARY KEY, start_time bigint, user_id int, song_id text, artist_id text, session_id int, location text, user_agent text);""")
...
(start_time bigint, hour int, day int, week int, month int, year int, weekday text);""")
